...
### Ubuntu Standalone 
- Follow [Manus' instructions][https://docs.manus-meta.com/2.4.0/Plugins/SDK/Linux/](https://docs.manus-meta.com/2.4.0/Plugins/SDK/Linux/) and install "Core Integrated" dependencies without Docker.
